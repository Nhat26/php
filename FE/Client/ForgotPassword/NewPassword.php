...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./newpassord.css">
  ...
  <section class="Form my-5 mx-5">
        <div class="container ">
            ...
            <div class="col-lg-7 px-5 pt-5"> 
                <h3 class="font-weight-bold py-3">Mật Khẩu Mới</h3>


                <form method="POST">
                    <div class="form-row">
                        <div class="col-lg-7">
                            <input type="password" placeholder="Nhập mật khẩu" name="pwd" class="form-control">
                        </div>
                    </div>
